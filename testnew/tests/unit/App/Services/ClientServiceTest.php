...
class ClientServiceTest extends \Raiadrogasil\Test\BaseTestCase
{
    private $request;
    ...
    protected function mockService($returnFindFirst, $isThrowException)
    {
        ...
        $repositoryMock = Mockery::mock(\App\Repositories\ClientRepository::class)->makePartial();
        ...
        $serviceMock = Mockery::mock(\App\Services\ClientService::class,[$repositoryMock])->makePartial();
    ...
    {
        $return = $this->mockService(null, null, null)->add(new \App\Domain\DTO\ClientDTO(), $this->request);
        $this->assertInstanceOf(\Raiadrogasil\Common\DTO\ReturnDTO::class, $return);
    }

    public function testUpdate()
    {
        $updateData = new \App\Domain\DTO\ClientDTO();
