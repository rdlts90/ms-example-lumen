...
class ClientControllerTest extends \Raiadrogasil\Test\BaseTestCase
{
    private $mockRequest;
    ...
    {
        $this->mockRequest = \Mockery::mock(\App\Http\API\v0\Requests\ClientRequest::class)->makePartial();
        ...
        $this->mockRequest->shouldReceive('validateUpdate', 'validateAdd')->andReturn(new \App\Domain\DTO\ClientDTO());
    ...
    {
        $mockService = Mockery::mock(\App\Services\ClientService::class)->makePartial();
        ...
        $mock = \Mockery::mock(\App\Http\API\v0\Controllers\ClientController::class, [$mockService])->makePartial();
