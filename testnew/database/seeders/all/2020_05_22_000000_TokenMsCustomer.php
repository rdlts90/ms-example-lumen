...
class TokenMsCustomer extends MigratableSeeder
{
    ...
    public function run(): void
    {
        ...
        DB::connection($typeConnection)->table(Configuration::TABLE)->insert([
            'name_group' => EnumConfiguration::TOKEN_GROUP_MS_CUSTOMER,
    ...
    public function down(): void
    {
        ...
        DB::connection($typeConnection)->table(Configuration::TABLE)
            ->where('name_group', EnumConfiguration::TOKEN_GROUP_MS_CUSTOMER)
